...
func (m *MockMeetRepo) GetByID(ctx context.Context, id uuid.UUID) (*meeting.Meeting, error) {
    if m.GetErr != nil {
        return nil, m.GetErr
    }
...
func (m *MockMeetRepo) Update(ctx context.Context, mm *meeting.Meeting) error {
    m.Updated = mm
    return nil
}
